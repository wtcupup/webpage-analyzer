...
class WebsiteListTest(TestCase):
    ...
    def test_websitelist_creation(self):
        ...
        self.assertEqual(w.__unicode__(), "anotherName")


class WebsiteTest(TestCase):
    def create_website(self, list=WebsiteList.objects.create(name="someName"), url= "http://www.disney.com", was_searched=True,count=0):
    ...
    def test_website_creation(self):
        ...
        self.assertEqual(w.__unicode__(), "http://nickelodeon.com")  # do we need to use reverse for this url?
